          ...
          <ScrollView ref={scrollRef} contentContainerStyle={styles.content}>
            ...
            <View style={styles.card}>
              ...
              <Text
                style={[
                  styles.tituloUno,
                  indicadorActual?.CategoriaColor && {
                    backgroundColor: indicadorActual.CategoriaColor,
                    color: '#fff',
                  },
                ]}
              >
              ...
              <View style={{ marginTop: 10 }}>
                {indicadorActual.Opciones.map((opcion) => {
                  ...
                  return (
                    <TouchableOpacity
                      key={opcion.Valor}
                      disabled={radioDeshabilitado}
                      style={[
                        styles.radioRow,
                        radioDeshabilitado && { opacity: 0.4 } // ← se ve opaco
                      ]} onPress={() => seleccionarOpcion(opcion.Valor)}
                    >
                      <View
                        style={[
                          styles.radioOuter,
                      ...
                      <Text style={styles.radioLabel}>{opcion.Texto}</Text>
                    </TouchableOpacity>
                  );
                })}
              </View>
